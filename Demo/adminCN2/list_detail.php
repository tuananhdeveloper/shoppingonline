 ...
 ?>
	<div id="wrapper">
		<table>
			...
			$result= mysqli_query($conn," SELECT a.username, b.* from orders as a, order_items as b WHERE b.order_id = $id and a.order_id = $id and a.branch='CN2' ");
			...
			$dem=1;
			require("../library/config.php");
			$result= mysqli_query($conn," SELECT a.username, b.* from orders as a, order_items as b WHERE b.order_id = a.order_id and a.branch='CN2' ");
			while( $data = mysqli_fetch_assoc($result)){
			echo "<tr>";
			echo "<td> $dem </td>";	
			echo "<td>$data[order_id]</td>";
