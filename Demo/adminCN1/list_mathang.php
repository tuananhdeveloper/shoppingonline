 ...
 ?>
	<div id="wrapper">
		<table>
			...
			$result= mysqli_query($conn,"select a.items_id,a.name,b.cate_title,a.price, a.quantity,a.branch from items as a, category as b where a.cate_id = b.cate_id AND a.branch='CN1'");
